...
/* MOTIVE
 * When we call construstor of child class then before getting child class construtor execution
 * the call goes to its just a level up parent class's constructor and after parent class's 
 * constructor exectuion child class's constructor get exectued as we can see fom the programm
*/
